...
const roofingPhases: Record<string, ChecklistPhaseDef> = {
  ...
  phase15: {
    ...
    items: [
      ...
      { id: "p15-3", text: "Exclusion language reviewed for completeness (cross-check Scope tab)" },
      { id: "p15-4", text: "Alternate pricing verified against base bid" },
      { id: "p15-5", text: "Bond cost included in final number (cross-check Gen Conds)" },
      { id: "p15-6", text: "Insurance cost included in final number (cross-check Gen Conds)" },
      { id: "p15-7", text: "Bid form completed per GC requirements" },
...
const universalPhases: Record<string, ChecklistPhaseDef> = {
  ...
  phase15: {
    ...
    items: [
      ...
      { id: "p15-3", text: "Exclusion language reviewed for completeness (cross-check Scope tab)" },
      { id: "p15-4", text: "Alternate pricing verified against base bid" },
      { id: "p15-5", text: "Bond cost included in final number" },
      { id: "p15-6", text: "Insurance cost included in final number" },
      { id: "p15-7", text: "Bid form completed per GC requirements" },
      { id: "p15-8", text: "Retainage terms reviewed (typical 5-10%)" },
      { id: "p15-9", text: "Liquidated damages clause reviewed" },
    ],
