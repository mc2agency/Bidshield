...
const roofingPhases: Record<string, ChecklistPhaseDef> = {
  ...
  phase4: {
    ...
    items: [
      ...
      { id: "p4-12", text: "Gypsum deck panel condition assessed — check for delamination/moisture damage", decks: ["gypsum"] },
      { id: "p4-13", text: "Gypsum board fastener pattern verified for FM/UL wind uplift", decks: ["gypsum"] },
      { id: "p4-14", text: "Tectum panel span/thickness confirmed against structural", decks: ["tectum"] },
      { id: "p4-15", text: "Tectum deck attachment method verified (clips, adhesive, mechanical)", decks: ["tectum"] },
      { id: "p4-16", text: "Plank deck joint condition assessed — check for cracking/spalling", decks: ["plank"] },
      { id: "p4-17", text: "Plank deck camber/deflection verified against structural tolerances", decks: ["plank"] },
      { id: "p4-18", text: "Plank fastener compatibility confirmed (no powder-actuated into precast)", decks: ["plank"] },
    ],
  },
  phase5: {
    key: "phase5",
