...
export default function ProductSchema({ name, description, price, image, url }: ProductSchemaProps) {
  const schema = {
    ...
    name,
    description,
    image: image || 'https://www.bidshield.co/bidshield-logo.jpg',
    url,
    brand: {
      '@type': 'Brand',
      name: 'BidShield',
...
export function BundleSchema() {
  const schema = {
    '@context': 'https://schema.org',
    '@type': 'Product',
    name: 'BidShield Complete Template Bundle - All 8 Roofing Estimating Templates',
    ...
    image: 'https://www.bidshield.co/bidshield-logo.jpg',
