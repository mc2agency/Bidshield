...
const TEMPLATES = [
  { id: 'asphalt-shingle', icon: '🏘️', title: 'Asphalt Shingle', titleEs: 'Teja Asfáltica', description: '3-tab, architectural, and designer shingles with pitch multipliers', descEs: 'Tejas de 3 lengüetas, arquitectónicas y de diseño con multiplicadores de pendiente', gumroad: 'https://estimatrix7.gumroad.com/l/qgdtph' },
  ...
  { id: 'tile', icon: '🏛️', title: 'Tile Roofing', titleEs: 'Techo de Teja', description: 'Concrete, clay, and interlocking tile with breakage factors', descEs: 'Teja de concreto, arcilla y entrelazada con factores de rotura', gumroad: 'https://estimatrix7.gumroad.com/l/mzrsum' },
