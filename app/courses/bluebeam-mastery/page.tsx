...
export const metadata: Metadata = {
  title: 'Bluebeam Mastery for Estimators - Complete Digital Takeoff Course | MC2 Academy',
  description: 'Master Bluebeam Revu for construction takeoff. 8 modules covering calibration, measurement tools, advanced techniques, and Excel reporting. Go from beginner to expert.',
  keywords: 'Bluebeam Revu training, digital takeoff course, construction measurement, PDF takeoff, Bluebeam for estimators, quantity takeoff'
};
    ...
    <main className="min-h-screen">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-blue-200">6+ Hours of Training</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              8 modules taking you from Bluebeam beginner to advanced estimator
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-blue-200">
              ...
              <p className="text-gray-700">
                You know the basics but want to unlock advanced features and learn proper workflows from an expert.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700 ml-4">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
                    <span><strong>Free Trial:</strong> 30-day full-featured trial available (enough to complete this course)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
              ...
              <div className="bg-white p-4 rounded-lg">
                <p className="text-sm text-gray-700">
                  <strong>Note:</strong> This course pays for itself in time saved on your first few estimates. Most students find the Bluebeam investment returns 10x+ in the first month through increased efficiency and accuracy.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <TestimonialCard
              ...
              quote="The custom tool sets alone saved me 20 hours in the first month. I had been using Bluebeam for years but was only scratching the surface. This course unlocked features I didn't know existed."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The Excel integration changed everything. I can export quantities and plug them directly into my templates. What used to take 3 hours now takes 30 minutes. This course paid for itself on day one."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I enrolled my entire team in this course. Everyone now uses the same workflow and custom tool sets. Our estimates are consistent, accurate, and fast. Team efficiency up 40%."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I was intimidated by Bluebeam's interface and stuck with manual takeoff for too long. This course made it simple and intuitive. Now I can't imagine going back. My accuracy has improved dramatically."
              rating={5}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              question="Do I need to own Bluebeam Revu to take this course?"
              answer="Not immediately. Bluebeam offers a 30-day free trial which is plenty of time to complete this course. You can decide to purchase the software after you've learned it and seen the value. The course also works with all Bluebeam Revu editions (Standard, CAD, eXtreme)."
            />

            <FAQItem
              question="I've never used Bluebeam before. Is this too advanced for me?"
              answer="Not at all! This course is designed for complete beginners. We start with the absolute basics (interface, navigation) and progressively build to advanced techniques. If you can use a computer and open a PDF, you can succeed in this course."
            />

            <FAQItem
              question="How long will it take to complete the course?"
              answer="The course contains 6+ hours of video content. Most students complete it in 1-2 weeks, practicing 3-5 hours per week. However, you have lifetime access, so you can learn at your own pace and revisit lessons anytime."
            />
            ...
            <FAQItem
              ...
              answer="You get lifetime access to all 8 modules (6+ hours), custom Bluebeam tool sets pre-configured for roofing, practice project files with real commercial drawings, report templates, tips & shortcuts guide, and a certificate of completion. Plus all future updates at no cost."
            />

            <FAQItem
              question="Can I use this on a Mac?"
              answer="Bluebeam Revu is Windows-only. Mac users can run it using Parallels Desktop, VMware Fusion, or Boot Camp. Many students successfully use Parallels and report it works perfectly. We include setup guidance for Mac users."
            />
            ...
            <FAQItem
              ...
              answer="Yes! Upon completion of all modules, you'll receive a professional certificate of completion that you can add to your LinkedIn profile, resume, or email signature."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Bluebeam Mastery - Complete Course</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>6+ hours of video training</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
