    ...
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              These advanced courses teach professional-grade software and sophisticated estimating techniques used by industry leaders.
            </p>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8 lg:p-12 border-2 border-purple-200">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Get access to all beginner, intermediate, and advanced courses with MC2 Pro membership. Master every tool and technique in the industry.
              </p>
              <div className="text-5xl font-bold text-blue-600 mb-2">$197<span className="text-2xl text-gray-600">/month</span></div>
              <p className="text-gray-600 mb-8">All 7 courses + templates + live Q&A + community access</p>
              <Link
                href="/membership"
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-1">Start with Fundamentals</h3>
                  <p className="text-gray-600">Build your foundation with Estimating Fundamentals course</p>
                  <Link href="/courses/estimating-fundamentals" className="text-blue-600 hover:text-blue-700 font-semibold">View Course →</Link>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Link href="/courses/bluebeam-mastery" className="text-blue-600 hover:text-blue-700 font-semibold">View Course →</Link>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <Link href="/courses/estimating-software" className="text-blue-600 hover:text-blue-700 font-semibold">View Course →</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link href="/courses" className="text-blue-600 hover:text-blue-700 font-semibold text-lg">
            ← View All Courses
          </Link>
        </div>
      </section>
