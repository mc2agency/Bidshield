...
export const metadata: Metadata = {
  title: 'AutoCAD for Submittals - Shop Drawing Course for Contractors | MC2 Academy',
  description: 'Learn AutoCAD essentials for creating professional shop drawings and submittal packages. Perfect for contractors who need CAD skills without becoming full-time drafters.',
  keywords: 'AutoCAD for contractors, shop drawings, construction submittals, CAD training, AutoCAD essentials, contractor CAD course'
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl sm:text-2xl text-blue-100 mb-8">
                Learn exactly what you need to create professional shop drawings and submittal packages. No fluff, just practical CAD skills for contractors.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">6 Focused Modules</div>
                  <div className="text-sm text-blue-200">8+ Hours of Training</div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-200">Real submittal packages to learn from</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-sm mt-1">✓</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-green-500 text-xl mt-1">✓</span>
                  <p>Learn only what contractors need - no architectural design fluff</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-500 text-xl mt-1">✓</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700">
                Drafting services charge $500-2,000 per submittal. Creating your own shop drawings pays for this course after just 1-2 projects.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              6 focused modules teaching only what contractors need - no architectural design theory
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700 ml-4">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
                    <span><strong>Free Trial:</strong> 30-day trial available (enough to complete most of this course)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
              ...
              <div className="border-t pt-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Free Alternatives (Covered in Course):</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 text-center mb-12">
            Real results from contractors who learned CAD skills
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="After 15 years of outsourcing shop drawings, I finally learned to do them myself. Saved over $8,000 in the first 6 months. The AutoCAD and SketchUp courses together helped me create submittals that impressed GCs and won bigger projects."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I was intimidated by CAD software and thought it was only for architects. This course made it approachable and taught exactly what contractors need. Now I can create professional shop drawings and make quick revisions."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Started with the free trial of AutoCAD and completed the course. By the time the trial ended, I had already created 3 submittal packages for active projects. Paid for AutoCAD subscription and this course within a month."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Learning AutoCAD opened up commercial opportunities we were passing on before. GCs now see us as a professional outfit that can handle complex projects with full submittal packages."
              rating={5}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              ...
              answer="No! This course is designed for complete beginners. We start with the absolute basics and build up to creating professional shop drawings. If you can use a computer, you can learn this."
            />

            <FAQItem
              question="Do I need to buy AutoCAD to take this course?"
              answer="Not immediately. AutoCAD offers a 30-day free trial which gives you time to learn and decide. The course also covers free alternatives like DraftSight and LibreCAD that work for most contractors."
            />

            <FAQItem
              question="How long will it take to complete the course?"
              answer="The course contains 8+ hours of video content. Most students complete it in 2-3 weeks, practicing 3-5 hours per week. You have lifetime access, so learn at your own pace."
            />

            <FAQItem
              question="Is AutoCAD LT sufficient, or do I need full AutoCAD?"
              answer="AutoCAD LT ($55/month) is perfect for shop drawings and submittal creation. You don't need full AutoCAD ($220/month) unless you're doing 3D modeling or advanced customization. We cover both in the course."
            />
            ...
            <FAQItem
              ...
              answer="Most drafting services charge $500-2,000 per submittal package. If you do 5-10 submittals per year, you'll save $2,500-20,000 annually. This course pays for itself after your first 1-2 projects."
            />

            <FAQItem
              question="What's included with my purchase?"
              answer="You get lifetime access to all 6 modules (8+ hours), AutoCAD template files, sample shop drawings, a detail library with common roofing details, alternative tools guide, submittal package examples, and a certificate of completion. Plus all future updates."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">AutoCAD Essentials for Contractors - Complete Course</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>6 focused modules</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>8+ hours of video training</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
