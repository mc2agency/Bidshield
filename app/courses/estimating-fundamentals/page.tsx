...
export const metadata: Metadata = {
  title: 'Estimating Fundamentals - Complete Construction Estimating Course | MC2 Academy',
  description: 'Master construction estimating from specifications to final bid. 8 comprehensive modules covering blueprints, takeoff, pricing, labor costs, and real project walkthroughs. Certificate included.',
  keywords: 'construction estimating course, roofing estimation training, reading blueprints, Bluebeam takeoff, labor burden calculation, estimating fundamentals'
};

export default function EstimatingFundamentalsPage() {
  return (
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">8 Comprehensive Modules</div>
                  <div className="text-sm text-blue-200">12+ Hours of Training</div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-200">Real commercial projects to learn from</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-sm mt-1">✓</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-red-500 text-xl mt-1">✗</span>
                  <p>Learning estimating by trial and error, losing bids or profit</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-blue-900 mb-6">
                This Course Will Transform Your Estimating
              </h2>
              <div className="space-y-4 text-gray-700">
                <div className="flex items-start gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              8 comprehensive modules taking you from reading plans to creating complete, winning estimates
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-50 rounded-xl p-8 border-2 border-blue-200">
              ...
              <p className="text-gray-700">
                New to construction estimating and want to learn the proper way from day one. No prior experience required.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  While Bluebeam is the industry standard and used in Module 4, you can follow along with the free trial version. Alternative PDF takeoff tools can also be used with the same principles.
                </p>
              </div>

              <div className="border-t pt-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Included with Course:</h3>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-gray-700">
                  <strong>Note:</strong> The majority of this course can be completed without purchasing any additional software. Bluebeam is recommended for Module 4, but a free trial is available for learning purposes.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 text-center mb-12">
            Real results from estimators who took this course
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="This course cut my estimate time from 4 hours to 45 minutes. I've already won 3 commercial bids using the templates. The ROI was immediate - this paid for itself in the first week."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="As someone new to estimating, this gave me the confidence to handle commercial projects. The module on labor burden was worth the price alone. I finally understand how to price my time accurately."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="After 10 years of estimating by gut feel, this course showed me what I was missing. I was leaving 8-12% on every estimate. The general conditions module alone saved me from costly mistakes."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="We enrolled our entire 3-person estimating team. The standardization has been incredible. Everyone now follows the same process, and our estimates are consistent and accurate. Best training investment we've made."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The multi-discipline coordination module was a game-changer. I was missing roof drains and HVAC curbs on almost every estimate. Haven't missed one since taking this course."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The Bluebeam training took me from manual takeoff to fully digital in 2 weeks. The templates are production-ready - I use them on every single estimate. This course is the real deal."
              rating={5}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              ...
              answer="No! This course is designed for complete beginners. We start with the fundamentals and build up to advanced concepts. If you can read and use Excel, you can succeed in this course."
            />

            <FAQItem
              question="How long will it take to complete the course?"
              answer="The course contains 12+ hours of video content. Most students complete it in 2-4 weeks studying a few hours per week. However, you have lifetime access, so you can learn at your own pace."
            />

            <FAQItem
              question="Do I need to buy Bluebeam Revu software?"
              answer="Bluebeam is recommended for Module 4 (Digital Takeoff), but it's not required. A free trial is available that lasts long enough to complete the course. You can also apply the same principles to other PDF takeoff software."
            />

            <FAQItem
              question="Will this work for residential estimating?"
              answer="While the course is focused on commercial roofing projects, all the principles apply to residential work as well. The templates and checklists are valuable for any roofing estimator."
            />

            <FAQItem
              question="What's included with my purchase?"
              answer="You get lifetime access to all 8 modules (12+ hours), all 5 roofing system templates ($195 value), the complete estimating checklist, practice drawing sets, Bluebeam templates, and a certificate of completion. Plus all future updates at no additional cost."
            />
            ...
            <FAQItem
              ...
              answer="Absolutely! For team training, you can purchase multiple licenses. For teams of 5+, contact us about corporate training packages with volume discounts."
            />

            <FAQItem
              question="Will I get a certificate?"
              answer="Yes! Upon completion of all modules, you'll receive a professional certificate of completion that you can add to your LinkedIn profile and resume."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join hundreds of estimators who have transformed their careers with this course
            </p>
          </div>

          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Estimating Fundamentals - Complete Course</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>12+ hours of video training</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
