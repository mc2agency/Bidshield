    ...
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Start your estimating career with these beginner-friendly courses. No prior experience required.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              These courses are designed for beginners with no prior estimating experience. Start building your foundation today.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready for Intermediate Courses?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Once you've mastered the basics, explore our intermediate courses to level up your skills.
          </p>
          <Link
