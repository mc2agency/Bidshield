...
export const metadata: Metadata = {
  title: 'Construction Submittals Course - Shop Drawings & RFIs | MC2 Academy',
  description: 'Master the complete submittal process for commercial construction. Learn shop drawings, product submittals, RFIs, change orders, and closeout documentation.',
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">6 Process Modules</div>
                  <div className="text-sm text-blue-200">4+ Hours of Training</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              6 modules covering the entire commercial construction submittal lifecycle
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-blue-200">
              ...
              <p className="text-gray-700">
                Need to train staff on submittal procedures or improve your company's submittal approval rate and turnaround time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="We were getting 60% of submittals rejected on first submission. After this course, we're at 95% approval rate. The templates alone saved us countless hours of rework."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The RFI module was a game-changer. We were writing vague questions that took weeks to get answered. Now our RFIs are clear and we get responses in days, not weeks."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Closeout was always a nightmare. Now we have a system. We got final payment on our last 3 projects within 2 weeks instead of the usual 2-3 months. This course literally paid for itself on the first project."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I was creating shop drawings from scratch every time. The templates and examples in this course standardized our entire process. We're faster and more professional now."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="New to commercial work and submittals were intimidating. This course broke down every step clearly. Now I confidently handle submittal requirements on $500k+ projects."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The submittal log template alone is worth the course price. We're tracking 15+ projects and nothing falls through the cracks anymore. GCs comment on how organized we are."
              rating={5}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <FAQItem
              ...
              answer="Not necessarily. We show both CAD and hand-sketched shop drawings. Many successful contractors use simple sketching tools or modify architect drawings in PDF editors. For advanced shop drawings, pair this with our AutoCAD or SketchUp courses."
            />

            <FAQItem
              question="What if I've never done commercial work before?"
              answer="Perfect! This course starts from the basics and assumes no prior submittal experience. We explain everything step-by-step, including industry terminology and GC/architect expectations."
            />
            ...
            <FAQItem
              ...
              answer="The course contains 4+ hours of video content. Most students complete it in 1-2 weeks. You have lifetime access, so learn at your own pace and reference it during actual projects."
            />

            <FAQItem
              question="What about digital submittal platforms like Procore or PlanGrid?"
              answer="We cover both paper and digital submittal workflows. The process is the same - digital platforms just change how you deliver documents. Understanding the fundamentals is critical regardless of platform."
            />

            <FAQItem
              question="Will this help me get paid faster?"
              answer="Absolutely. Module 6 on closeout documentation is specifically designed to help you organize final paperwork so you can get final payment quickly. Many students report 50-75% faster payment after implementing the closeout system."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Construction Submittals Masterclass - Complete Course</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    <span>6 process modules</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>4+ hours of training</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
