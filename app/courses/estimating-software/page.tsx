...
export const metadata: Metadata = {
  title: 'Estimating Software & AI Tools Course - Modern Construction Tech | MC2 Academy',
  description: 'Master construction estimating software, AI tools, and automation. Learn AccuLynx, JobNimbus, AI assistants, and workflow optimization for faster, more accurate estimates.',
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">8 Software Modules</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>• Learning curve: Medium-High</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              8 modules covering modern estimating software, AI tools, and automation workflows
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="The AI module changed everything. I'm using ChatGPT to analyze 50+ page specs in minutes instead of hours. The prompt library alone is worth 10x the course price."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="We were evaluating AccuLynx vs. JobNimbus. This course broke down exactly which was better for our size. Saved us from a $15,000 mistake by picking the wrong platform."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I've been using Excel for 15 years but the advanced formulas module showed me features I never knew existed. My templates are now 10x more powerful and bulletproof."
              rating={5}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              question="Do I need to buy software to take this course?"
              answer="No! This course teaches you ABOUT software so you can make informed decisions. Most platforms offer free trials or demos. You'll learn what to buy (or not buy) based on your specific needs."
            />

            <FAQItem
              question="Is AI really useful for estimating, or just hype?"
              answer="AI is incredibly useful when used correctly. This course shows exactly where AI excels (spec analysis, research, validation) and where it fails (pricing decisions, final approvals). You'll learn to use AI as a powerful assistant, not a replacement for expertise."
            />

            <FAQItem
              question="I'm not tech-savvy. Will this be too advanced?"
              answer="Not at all! We start with fundamentals and build up. The course is designed for contractors first, tech people second. If you can use Excel and email, you can learn these tools."
            />

            <FAQItem
              question="Which software should I buy: AccuLynx or JobNimbus?"
              answer="It depends on your business! Module 1 and 2 provide a complete comparison framework. Generally, AccuLynx is better for larger commercial contractors, JobNimbus for smaller residential companies. But there are many factors - the course covers all of them."
            />

            <FAQItem
              question="Will AI replace estimators?"
              answer="No. AI is a tool that makes good estimators great. It handles tedious tasks (reading specs, research, data entry) so you can focus on judgment, strategy, and client relationships. This course shows you how to stay ahead by embracing AI, not fearing it."
            />

            <FAQItem
              question="Can I really automate my workflow?"
              answer="Yes! Module 6 shows exactly how. Most contractors have 5-10 hours per week of manual data entry that can be automated with tools like Zapier. Students report saving 10-20 hours per month after implementing the automation workflows."
            />

            <FAQItem
              question="What's included with my purchase?"
              answer="Lifetime access to all 8 modules (6+ hours), software comparison charts, AI prompt library, automation templates, integration guides, and a certificate of completion. Plus all future updates as technology evolves."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Estimating Software & AI Tools - Complete Course</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    <span>8 software modules</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
                    <span>6+ hours of training</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
