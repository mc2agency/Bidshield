...
export const metadata: Metadata = {
  title: 'SketchUp for Visualization Course - 3D Modeling for Contractors | MC2 Academy',
  description: 'Learn SketchUp for roofing and construction visualization. Create stunning 3D models, client presentations, and shop drawings. Perfect for contractors who want to impress clients.',
    ...
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl sm:text-2xl text-blue-100 mb-8">
                Create stunning 3D models and visualizations that wow clients. Learn SketchUp from a contractor's perspective - no architecture degree needed.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">6 Practical Modules</div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-200">Complete models to learn from and modify</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-sm mt-1">✓</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-green-500 text-xl mt-1">✓</span>
                  <p>Learn SketchUp quickly - easier than AutoCAD for most contractors</p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-green-500 text-xl mt-1">✓</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700">
                SketchUp's intuitive interface lets you build 3D models as naturally as sketching on paper. No complex commands or steep learning curve.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              6 hands-on modules teaching SketchUp specifically for construction visualization
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700 ml-4">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
                    <span><strong>Perfect for:</strong> Learning, simple models, client presentations</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 mt-1">•</span>
              ...
              <div className="bg-white p-4 rounded-lg">
                <p className="text-sm text-gray-700">
                  <strong>Course Note:</strong> This entire course can be completed with SketchUp Free. We cover Pro features in Module 6, but you can skip that module or upgrade later if needed. Start learning for $0!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="My close rate went from 40% to 68% after I started showing clients 3D models. They can actually SEE what they're getting. This course paid for itself in the first week with one high-end residential job."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I tried learning AutoCAD and gave up. SketchUp clicked immediately. Now I'm creating shop drawings and client presentations that look like they came from an architect. Clients are blown away."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The coordination module saved our bacon on a $800k project. We found conflicts with HVAC curbs in SketchUp before they became expensive field problems. Worth 100x the course price."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Started with SketchUp Free and the course templates. Built my first 3D model in under an hour. Now every proposal includes a visualization. I'll never go back to 2D-only presentations."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The material library and textures alone are worth the course. I can show clients different roofing options (colors, materials) in 3D before they commit. Upsells have increased 30%."
              rating={5}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              question="Do I need to buy SketchUp to take this course?"
              answer="No! SketchUp Free (web version) is completely free and powerful enough for 95% of what contractors need. You can complete the entire course without spending a dime on software. We cover SketchUp Pro features, but they're optional."
            />

            <FAQItem
              question="I'm not artistic or good at drawing. Can I still learn this?"
              answer="Absolutely! SketchUp is more like digital Legos than artistic drawing. If you can click and drag, you can build 3D models. The course is designed for contractors, not artists. No artistic ability required."
            />

            <FAQItem
              question="How long until I can create my first client presentation?"
              answer="Most students create their first simple roof model in Module 2 (first 2-3 hours). By Module 5, you'll be creating full client presentations. Many students use SketchUp on real quotes within the first week."
            />

            <FAQItem
              question="Is SketchUp better than AutoCAD for shop drawings?"
              answer="It depends. SketchUp is easier to learn and better for visualization. AutoCAD is more precise for technical drawings. Many contractors use SketchUp for client presentations and coordination, then AutoCAD for final shop drawings. We cover both approaches."
            />
            ...
            <FAQItem
              ...
              answer="Lifetime access to all 6 modules (5+ hours), SketchUp template library, material and texture library, component library, presentation templates, plugin recommendations, and certificate of completion. Plus all future updates."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">SketchUp for Visualization - Complete Course</h3>
