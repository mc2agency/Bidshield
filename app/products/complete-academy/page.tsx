...
export default function CompleteAcademyPage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl sm:text-2xl text-green-100 mb-8">
                Every single product and course we offer in one comprehensive package. From complete beginner to expert estimator - this is everything you need to master construction estimating.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <div className="bg-white rounded-lg p-6 mb-4">
                  <div className="text-gray-900 text-center">
                    ...
                    <h3 className="font-bold text-xl mb-2">Complete Academy Includes:</h3>
                    <div className="text-left space-y-2 text-sm">
                      ...
                      <div className="flex items-center gap-2 ml-4">
                        ...
                        <span className="text-xs">All templates, guides & 3 courses</span>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold">Every Product & Course We Offer</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From zero to expert - the Complete Academy is the most comprehensive construction estimating training program available
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-5xl mb-4">🎓</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Every Course</h3>
              <p className="text-gray-600">
                Complete training from estimating fundamentals to advanced software and visualization techniques.
              </p>
            </div>
      ...
      <section id="whats-included" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Everything Included in Complete Academy
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Individual value: $1,985 - Academy price: $997 (Save $988)
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-100 rounded-xl p-8 mb-8 border-2 border-purple-200">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">Core Courses:</h4>
                <ul className="space-y-1 text-sm text-gray-700">
                  <li className="flex items-center gap-2">
                    <span className="text-green-500">✓</span>
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Complete your mastery with these additional specialized courses</p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-2xl font-bold text-gray-900">SketchUp Visualization Course</h3>
                    <span className="text-green-600 font-semibold text-xl">$97 Value</span>
                  </div>
                  <p className="text-gray-600 mb-4">
                    Create 3D visualizations of your roofing projects for better client presentations and design coordination. Learn the most popular 3D modeling software in construction.
                  </p>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border-2 border-green-300">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-2xl font-bold text-gray-900">Construction Submittals Course</h3>
                    <span className="text-green-600 font-semibold text-xl">$197 Value</span>
                  </div>
                  <p className="text-gray-600 mb-4">
                    Master the complete submittal process from product data sheets to shop drawings. Learn what GCs and architects expect and how to get submittals approved quickly.
                  </p>
                  <ul className="grid md:grid-cols-2 gap-3">
                    <li className="flex items-start gap-2 text-gray-700">
                      <span className="text-green-500 mt-1">✓</span>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border-2 border-green-300">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-2xl font-bold text-gray-900">Estimating Software Course</h3>
                    <span className="text-green-600 font-semibold text-xl">$197 Value</span>
                  </div>
                  <p className="text-gray-600 mb-4">
                    Learn the major estimating software platforms used in commercial construction including STACK, PlanSwift, On-Screen Takeoff, and cloud-based solutions.
                  </p>
                  <ul className="grid md:grid-cols-2 gap-3">
                    <li className="flex items-start gap-2 text-gray-700">
                      <span className="text-green-500 mt-1">✓</span>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border-2 border-green-300">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Complete Academy Value Breakdown</h2>
            <div className="space-y-3 mb-6">
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-700">SketchUp Visualization Course</span>
                <span className="font-semibold text-gray-900">$97</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">Construction Submittals Course</span>
                <span className="font-semibold text-gray-900">$197</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700">Estimating Software Course</span>
                <span className="font-semibold text-gray-900">$197</span>
              </div>
              ...
              <div className="flex justify-between items-center text-xl bg-white rounded-lg p-4">
                <span className="font-bold text-green-600">Complete Academy Price:</span>
            ...
            <div className="bg-green-100 rounded-lg p-4 mt-4 text-center">
              <p className="text-gray-900 font-semibold">That's every single product and course we offer - nothing held back!</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="font-bold text-lg text-gray-900 mb-2">All-In Learners</h3>
              <p className="text-gray-600 text-sm">
                Committed to becoming an expert estimator and want the most comprehensive training available. You want to learn everything, not just pieces.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600 text-sm">
                Know you'll eventually want all our courses and want the best possible price. Save $988 versus buying individually.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Start with Estimating Fundamentals and Bluebeam Mastery. Use the templates to practice on real projects. Read the business guides to understand the industry.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Master AutoCAD for Submittals and Measurement Technology. Learn how to create shop drawings and use modern measurement tools for accurate takeoffs.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Complete SketchUp Visualization, Construction Submittals, and Estimating Software courses. Master the advanced skills that set you apart from other estimators.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">Apply everything you've learned to real projects. Use the templates and systems daily. Continue refining your skills with lifetime access to all content and updates.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">How long does it take to complete the Complete Academy?</h3>
              <p className="text-gray-600">
                Most dedicated students complete everything in 3-6 months studying 10-15 hours per week. However, you have lifetime access so you can take as long as you need. Many people start applying what they learn immediately while still working through the courses.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Yes! The Complete Academy includes every single product, template, guide, and course we've created. Nothing is held back. If we create new products in the future, you'll get access to those too as part of your lifetime updates.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                You'll need Microsoft Excel (or Google Sheets) for the templates. For the courses, you'll eventually need Bluebeam Revu, AutoCAD (or AutoCAD LT), and SketchUp. Most have free trials, and we provide guidance on getting educational or subscription pricing.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                The Complete Academy provides all the knowledge and skills you need. Combined with hands-on practice (estimating real projects), most students develop expert-level capabilities. Many graduates are working as senior estimators or running their own companies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Yes! Email support is included for life. You can ask questions about course content, how to use templates, or get advice on specific estimating situations. We're committed to your success.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-green-50 border-2 border-green-500 rounded-xl p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-4">
              We're so confident the Complete Academy will transform your career that we offer a full 30-day money-back guarantee. If you're not completely satisfied, just email us for a full refund - no questions asked.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Link href="/products/starter-bundle" className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border-2 border-blue-200">
              ...
              <p className="text-gray-600 mb-4">
                Templates, guides, and Bluebeam training. Perfect for getting started with professional estimating.
              </p>
            ...
            <Link href="/products/professional-bundle" className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-shadow border-2 border-purple-200">
              ...
              <p className="text-gray-600 mb-4">
                Everything in Starter + Estimating Fundamentals, AutoCAD, and Measurement Technology courses.
              </p>
              <div className="flex items-baseline gap-3 mb-4">
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-900 via-green-800 to-teal-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8">
            Get lifetime access to every product and course we offer - the most comprehensive construction estimating education available
          </p>
