        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-200">
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">4. Payment and Billing</h2>

              <h3 className="text-xl font-bold mt-6 mb-3 text-gray-800">4.1 Pricing</h3>
              <p className="text-gray-700 mb-4">
                All prices are in USD and subject to change. We reserve the right to modify pricing with
                30 days notice to existing customers. Price changes do not affect active subscriptions
                until renewal.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                BidShield Pro is billed monthly at $249/month or annually at $2,988/year. Subscriptions automatically renew
              ...
              <h3 className="text-xl font-bold mt-6 mb-3 text-gray-800">5.3 Restrictions</h3>
              <p className="text-gray-700 mb-4">
                You may NOT:
              </p>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">6. User-Generated Content</h2>
              <p className="text-gray-700 mb-4">
                If you submit comments, reviews, questions, or other content, you grant us a
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">7. Prohibited Uses</h2>
              <p className="text-gray-700 mb-4">
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">12. Modifications to Terms</h2>
              <p className="text-gray-700 mb-4">
                We may update these Terms from time to time. We will notify you of significant changes
                by email or by posting a notice on our website. Continued use of our services after
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">15. Contact Information</h2>
              <p className="text-gray-700 mb-4">
