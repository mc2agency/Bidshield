            ...
            <div className="sticky top-24 bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/resources/roofing-systems/tpo-pvc-epdm" className="text-sm text-blue-600 hover:text-blue-700">
                      → Single-Ply Systems
                    </Link>
                  </li>
                  <li>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        <strong>Safety Note:</strong> Torch-applied systems involve open flame and require proper safety tools, hot work permits, and fire watch procedures. Always check local code requirements and insurance restrictions.
                      </p>
                    </div>
                  </div>
                </div>
