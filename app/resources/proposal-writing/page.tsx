            ...
            <div className="sticky top-24 bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/resources/finding-work" className="text-sm text-emerald-600 hover:text-emerald-700">
                      → Finding Work
                    </Link>
                  </li>
                  <li>
                    <Link href="/resources/estimating-best-practices" className="text-sm text-emerald-600 hover:text-emerald-700">
                  ...
                  <div>
                    ...
                    <div className="bg-white border-2 border-emerald-500 rounded-lg p-6 my-6">
                      ...
                      <div className="bg-gray-50 rounded p-4 text-sm text-gray-700 italic leading-relaxed">
                        ...
                        <p className="mb-3">
                          Thank you for the opportunity to submit our proposal for the roof replacement at Oakwood Elementary School. We understand the importance of completing this work during the summer break to minimize disruption to users and staff.
                        </p>
                        <p className="mb-3">
              ...
              <section id="differentiation" className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border-2 border-teal-600 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-700 mb-3">
                      Showcase relevant certifications, specialized tools, or manufacturer partnerships.
                    </p>
