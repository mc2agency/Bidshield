        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              ...
              From measurement tools to AI-powered estimating software, learn what to use and how to use it.
            </p>
                ...
                },
                {
                  ...
                  tools: [
                    ...
                    },
                    {
                      ...
                      level: 'Optional',
                      cost: '$299/year',
                      features: ['3D roof modeling', 'Quick visualization', 'Easy to learn', 'Presentation tools']
                    }
                  ]
                },
                {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <FreeResource
                ...
                type="Video"
                href="/learning/videos/bluebeam-basics"
              />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <CourseCard
                ...
                price="$197"
                description="Complete training on Bluebeam Revu for professional digital takeoffs and markups."
                href="/courses/bluebeam-mastery"
              />
              <CourseCard
                title="Estimating Software Course"
                price="$297"
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Get Access to All Technology Training
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            MC2 Pro membership includes complete training on Bluebeam, AutoCAD, SketchUp,
...
function CourseCard({ title, price, description, href }: {
  title: string;
  price: string;
  description: string;
  href: string;
