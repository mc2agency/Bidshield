            ...
            <div className="sticky top-24 bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/courses/bluebeam-mastery" className="text-sm text-emerald-600 hover:text-emerald-700">
                      → Bluebeam Mastery Course
                    </Link>
                  </li>
                  <li>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <section className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-8 text-center text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/courses/estimating-software" className="px-8 py-3 bg-white/10 text-white rounded-lg font-semibold hover:bg-white/20 transition-colors border border-white/20">
                    Software Mastery Course - $197
                  </Link>
                </div>
              </section>
