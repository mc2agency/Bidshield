            ...
            <div className="sticky top-24 bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/courses/construction-submittals" className="text-sm text-emerald-600 hover:text-emerald-700">
                      → Submittals Course
                    </Link>
                  </li>
                  <li>
                    <Link href="/learning/plans-and-specs" className="text-sm text-emerald-600 hover:text-emerald-700">
                      → Reading Plans & Specs
                    </Link>
                  </li>
                </ul>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
                ...
                <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-xl p-6 text-white">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div className="bg-white/10 rounded p-4">
                      ...
                      <p className="text-slate-400">Full-featured construction management with submittal module</p>
                    </div>
                    <div className="bg-white/10 rounded p-4">
              ...
              <section className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-8 text-center text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
                  ...
                  <div className="text-slate-400">Complete course with templates & examples</div>
                </div>
                ...
                <p className="text-sm text-slate-400 mt-4">
                  Or get access to this + all courses with MC2 Pro Membership
                </p>
              </section>
