        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              ...
              Learn to identify roofing scope, coordinate trades, and catch errors before they become costly mistakes.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 text-center mb-12">
              Start learning with these free guides and videos
            </p>
            ...
            <div className="space-y-6">
              ...
              <FreeResource
                ...
                type="Video Tutorial"
                href="/learning/videos/csi-masterformat"
              />
              <FreeResource
                icon="📋"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <CourseCard
                ...
                price="$497"
                description="Complete course covering plan reading, scope development, and accurate estimating."
                href="/courses/estimating-fundamentals"
              />
              <CourseCard
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Join the Estimating Fundamentals course and learn the complete system for reading plans,
