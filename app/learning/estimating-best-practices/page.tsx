      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300">
            Master the techniques that separate professional estimators from the rest. Learn accuracy, efficiency, and consistency.
          </p>
        </div>
      </section>
            ...
            <div className="sticky top-24 bg-white rounded-xl shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/courses/estimating-fundamentals" className="text-sm text-emerald-600 hover:text-emerald-700">
                      → Estimating Fundamentals Course
                    </Link>
                  </li>
                  <li>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              ...
              <section className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-8 text-center text-white">
                ...
                <p className="text-slate-300 mb-6">
                  Take the complete Estimating Fundamentals course and learn everything from takeoff to proposal.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/courses/estimating-fundamentals" className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all">
                    View Course - $497
                  </Link>
