                  ...
                  <div className="bg-white border-l-4 border-blue-500 p-6 shadow-sm">
                    ...
                    <div className="bg-gray-50 rounded p-4 text-sm">
                      ...
                      <p className="text-gray-600">
                        <strong>Where to Install:</strong> Eaves (2 courses minimum in cold climates), valleys, skylights, chimneys, step flashings, low-pitch areas
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-gray-50 rounded p-3 text-xs">
                            ...
                            <div>Ice & water: Eaves (2 courses = 6 LF) + valleys</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <section id="common-mistakes" className="mb-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-red-50 border-l-4 border-red-500 p-6">
                    ...
                    <p className="text-xs text-red-700 bg-red-100 rounded p-2">
                      <strong>Fix:</strong> Include 2 courses (6 LF) at all eaves, plus full coverage in valleys and around penetrations.
                    </p>
                  </div>
