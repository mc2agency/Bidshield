            ...
            <div className="sticky top-24 bg-white rounded-lg shadow-md p-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/learning/roofing-systems" className="text-sm text-blue-600 hover:text-blue-700">
                      → Roofing Systems
                    </Link>
                  </li>
                  <li>
          ...
          <article className="lg:col-span-3">
                ...
                <div className="grid md:grid-cols-2 gap-6 my-6">
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-sm text-red-800">
                      ...
                      <li>• Learning curve for flying and processing</li>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mt-8 border-2 border-blue-500">
              <div className="text-center">
                ...
                <Link
                  href="/courses/digital-measurement"
                ...
                <p className="text-sm text-gray-500">Instant access • Certificate included • 30-day guarantee</p>
              </div>
            </div>
          </article>
        </div>
