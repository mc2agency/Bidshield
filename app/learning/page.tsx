        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <LearningCard
              ...
              premium="Digital Measurement Course - $97"
            />
            ...
            <LearningCard
              ...
              premium="Estimating Fundamentals Course - $497"
            />
            ...
            <LearningCard
              ...
              icon="🧮"
              href="/learning/estimating-best-practices"
              topics={[
                'Waste factors',
                'Labor burden',
                'General conditions',
              ...
              premium="Estimating Fundamentals - $497"
            />
            ...
            <LearningCard
              ...
              icon="⚡"
              href="/learning/software-technology"
              topics={[
                'Bluebeam basics',
                'Estimating software',
                'AI tools overview',
            ...
            <LearningCard
              ...
              icon="📄"
              href="/learning/proposal-writing"
              topics={[
                'Proposal structure',
                'Scope of work',
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join MC2 Pro for unlimited access to all courses, templates, tools, and monthly live Q&A sessions.
          </p>
