          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl sm:text-2xl text-blue-100 mb-8">
                Master modern measurement technology. From satellite reports to drones, master every digital tool that's transforming roofing.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <div className="space-y-1">
                  <div className="text-sm text-blue-200">7 Technology Parts</div>
            ...
            <div className="bg-blue-800/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-600">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold">Satellite Report Guide</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700 mb-4">
                EagleView, Hover, CoreLogic, and other satellite measurement services. Master accuracy, limitations, and when to use each.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              7 parts covering every modern measurement technology for roofing contractors
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <PartCard
              number={1}
              title="Satellite Measurement Basics"
              duration="50 minutes"
              sections={[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <TestimonialCard
              ...
              quote="I was skeptical about satellite reports until this tool. Now I understand when they're accurate and when to verify. Haven't climbed a residential roof in 6 months. My insurance company loves it too."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The EagleView guide was game-changing. I was ordering reports but not using half the features. Now I'm using SmartBuild for visualizations that close more sales. Worth every penny."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Bought a drone after this tool and it paid for itself in 2 months. I'm now the only contractor in my area offering aerial roof inspections. It's a huge competitive advantage."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="Finally understand which technology to use for which job type. No more wasting money on satellite reports for small jobs or climbing dangerous commercial roofs. This tool has structure and strategy."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="The Hover app section alone was worth the tool price. We now create 3D models for every homeowner presentation. Our close rate went from 35% to 52% in 3 months."
              rating={5}
            ...
            <TestimonialCard
              ...
              quote="I was ordering the wrong type of satellite reports and overpaying. This tool showed me exactly what to buy for each situation. Probably saving $200-300/month on measurement costs alone."
              rating={5}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <FAQItem
              question="Do I need to buy any software or tools to use this tool?"
              answer="No! This tool teaches you ABOUT various technologies so you can make informed decisions. You don't need to own EagleView, drones, or Hover to master. We provide demos and examples of everything."
            />

            <FAQItem
              question="Will this tool help me decide which technology to invest in?"
              answer="Absolutely! That's the primary goal. Part 6 is entirely focused on ROI analysis and technology selection based on your business size, market, and budget. You'll know exactly what to buy (or not buy)."
            />

            <FAQItem
              question="Do I need a drone pilot license?"
              answer="If you want to fly drones commercially, yes - you need an FAA Part 107 license. This tool covers what's required and how to get licensed. However, you can still master drone technology without having the license yet."
            />

            <FAQItem
              question="How accurate are satellite reports really?"
              answer="Generally ±2-5% when conditions are ideal (good imagery, simple roof). This tool teaches you how to spot potential issues and when satellite reports are vs. aren't reliable. You'll get verification techniques too."
            />
            ...
            <FAQItem
              ...
              answer="It depends on your volume and budget. The tool covers the complete spectrum from free mobile apps to $5,000 drone setups. Most residential contractors find the sweet spot with satellite reports ($30-40 each) or Hover ($50/month)."
            />

            <FAQItem
              question="How long does it take to complete?"
              answer="The tool contains 5+ hours of video content. Most users complete it in 1-2 weeks. You have lifetime access, so work at your own pace and revisit sections when you're ready to invest in specific technology."
            />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white text-gray-900 rounded-2xl p-8 lg:p-12 shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">Roof Measurement & Technology - Complete Tool</h3>
