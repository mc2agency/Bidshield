...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }> = [
    ...
    { path: '/compare/bidshield-vs-manual-review',     priority: 0.8, changeFrequency: 'monthly' },
    ...
    { path: '/products/asphalt-shingle',               priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/tpo',                           priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/epdm',                          priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/metal',                         priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/tile',                          priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/bur',                           priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/sbs',                           priority: 0.7, changeFrequency: 'monthly' },
    { path: '/products/spray-foam',                    priority: 0.7, changeFrequency: 'monthly' },
