...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/api/og?title=What is a Roof Square? Complete Guide to Roofing Measurements [2025]&type=article",
        width: 1200,
        height: 630,
        alt: "What is a Roof Square? Complete Guide to Roofing Measurements [2025]",
      },
    ],
  },
  twitter: {
