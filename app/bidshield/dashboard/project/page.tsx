  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="bg-white border-b border-slate-200">
        <div className="px-4 sm:px-6 py-3 max-w-[1400px] mx-auto flex items-center gap-3">
      ...
      <div className="flex-1 px-4 sm:px-6 py-4 max-w-[1400px] mx-auto w-full flex flex-col gap-4">
