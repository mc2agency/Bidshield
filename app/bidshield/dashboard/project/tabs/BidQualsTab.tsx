    ...
    <div className="flex flex-col gap-4 max-w-2xl">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        {!isDemo && saveStatus !== "idle" && (
          <div className="flex items-center gap-1.5 text-xs mt-1" style={{ color: saveStatus === "saved" ? "var(--bs-teal)" : "var(--bs-text-dim)" }}>
            {saveStatus === "saving" ? (
              <><svg className="animate-spin" width={12} height={12} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83"/></svg>Saving…</>
            ) : (
