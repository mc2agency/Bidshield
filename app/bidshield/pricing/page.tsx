    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        <p className="text-lg text-slate-600 mb-2">
          The bid QA tool built for commercial roofing estimators. Catches scope gaps, missed addenda, and pricing errors before you submit.
        </p>
      ...
      {/* Billing toggle + pricing cards (client component) */}
      <PricingCards />
