...
const PRO_FEATURES = [
  ...
  "## AI Features",
  "✨ AI Spec Extraction (PDF → project data)",
  ...
  "✨ Exclusions Coverage Validator",
  "✨ Draft RFI with AI",
  "✨ RFI Risk Flagger (spec scan)",
  "✨ Addendum Impact Check",
  "✨ Submittal Checklist Generator",
  "✨ Bid Arithmetic Audit",
  "✨ Labor Rate Sanity Check",
  "✨ Spec-to-Bid Alignment Scanner",
  "✨ Warranty Coverage Validator",
  "✨ Bid Competitiveness Benchmarker",
  "## Support",
