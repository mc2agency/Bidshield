...
export const LAYER_NORMALIZATION_RULES: LayerNormalizationRule[] = [
  ...
  // ─── Membrane variants ────────────────────────────────────────────────────────
  {
    ...
    description: "Primary roofing membrane layer",
  },
  ...
  // ─── Ballast variants ─────────────────────────────────────────────────────────
  {
    ...
    regexPatterns: [
      /\bballast\b/i,
      /river[\s_-]?(stone|rock|ballast)/i,
      /paver[\s_-]?ballast/i,
      /ballast[\s_-]?paver/i,
      /lock[\s_-]?down[\s_-]?paver/i,
      /concrete[\s_-]?paver[\s_-]?ballast/i,
      /gravel[\s_-]?ballast/i,
      /\baggregate\b/i,
      /stone[\s_-]?ballast/i,
    ],
  ...
  // ─── Green roof variants ──────────────────────────────────────────────────────
  {
    ...
    regexPatterns: [
      ...
      /vegetation[\s_-]?(layer|tray)/i,
      /\bvegetation\b/i,
      /(growing|growth|planting)[\s_-]?media/i,
      /sedum[\s_-]?tray/i,
      /planted[\s_-]?roof/i,
      /vegetated[\s_-]?roof/i,
      /sustainable[\s_-]?roof/i,
      /green[\s_-]?roof[\s_-]?zone/i,
      /growth[\s_-]?medium/i,
    ],
  ...
  // ─── Waterproofing variants ───────────────────────────────────────────────────
  {
    ...
    description: "Waterproofing membrane (below-grade / plaza / LAM)",
  },
];
